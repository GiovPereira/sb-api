...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .hasRole("ADMIN")
                .antMatchers("/api/v1/editoras/**")
                .hasRole("ADMIN")
                .antMatchers("/api/v1/generos/**")
                .hasRole("ADMIN")
                .antMatchers("/api/v1/idiomas/**")
                .hasRole("ADMIN")
                .antMatchers("/api/v1/secoes/**")
                .hasRole("ADMIN")
                .antMatchers("/api/v1/statusexemplares/**")
                .hasRole("ADMIN")
                .antMatchers("/api/v1/statusreservas/**")
                .hasRole("ADMIN")
                .antMatchers("/api/v1/duracaopadraoemprestimos/**")
                .hasRole("ADMIN")
                .antMatchers("/api/v1/duracaopadraoreservas/**")
                .hasRole("ADMIN")
                .antMatchers("/api/v1/valordiariomultas/**")
                .hasRole("ADMIN")
